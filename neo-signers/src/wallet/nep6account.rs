use crate::{wallet::nep6contract::NEP6Contract, NEP6Parameter, WalletError};
use getset::{Getters, Setters};
use neo_codec::encode::NeoSerializable;
use neo_providers::core::{account::Account, transaction::verification_script::VerificationScript};
use neo_types::{
	address::Address, address_or_scripthash::AddressOrScriptHash,
	contract_parameter_type::ContractParameterType, string::StringExt, util::ToBase64,
};
