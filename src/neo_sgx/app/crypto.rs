...
impl SgxCrypto {
    ...
    ///
    /// A 65-byte signature
    pub fn sign_message(&self, private_key: &[u8; 32], message: &[u8]) -> Result<[u8; 65], sgx_status_t> {
    ...
    pub fn verify_signature(&self, public_key: &[u8; 64], message: &[u8], signature: &[u8; 65]) -> Result<bool, sgx_status_t> {
        let mut result = 0i32;
        let mut retval = sgx_status_t::SGX_SUCCESS;
