...
use neo::prelude::{
	...
	deserialize_vec_script_hash_option, serialize_scopes, serialize_script_hash,
	serialize_vec_public_key_option, serialize_vec_script_hash_option, Decoder, Encoder,
