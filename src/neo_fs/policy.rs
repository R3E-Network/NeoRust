...
impl ExtendedAclBuilder {
    ...
    pub fn build(self) -> NeoFsResult<ExtendedAcl> {
        let container_id = self.container_id
            .ok_or_else(|| crate::neo_fs::errors::NeoFsError::InvalidResponse(
...
impl EaclRecordBuilder {
    ...
    pub fn attribute_filter(mut self, key: impl Into<String>, value: impl Into<String>) -> Self {
        self.filters.push(EaclFilter::Attribute {
            key: key.into(),
            value: value.into(),
        });
        self
    ...
    /// Add a header filter
    pub fn header_filter(mut self, header_type: HeaderType, match_type: MatchType, value: impl Into<String>) -> Self {
        self.filters.push(EaclFilter::Header {
            header_type,
            match_type,
            value: value.into(),
        });
