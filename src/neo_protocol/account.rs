...
use signature::{Error, hazmat::PrehashSigner};
...
mod tests {
    ...
    use neo::prelude::{
        Account, AccountTrait, BodyRegexMatcher, HttpProvider, KeyPair,
        NeoSerializable, Provider, ProviderError, ScriptHashExtension,
