...
use neo_crypto::{hash::HashableForVec, key_pair, key_pair::KeyPair, keys::Secp256r1Signature};
...
impl InvocationScript {
	...
	pub fn get_signatures(&self) -> Vec<Secp256r1Signature> {
		let mut reader = neo_codec::Decoder::new(&self.script);
