...
//!
//! ```rust
//! use neo_types::Account;
//! use neo_crypto::PrivateKey;
//!
...
//!
//! ```rust
//! use neo_crypto::{PrivateKey, encrypt_to_nep2, decrypt_from_nep2};
//!
//! // Encrypt a private keywith a password (NEP-2 format)
